...
// Retrieved 2025-12-06, License - CC BY-SA 4.0
      ...
      <div className="p-6 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white/80 backdrop-blur-md z-20 min-h-[80px]">
        {!isCollapsed && (
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg tracking-tight text-slate-900 leading-none mb-1">AETHERIA</h1>
  ...
  <button 
    ...
    className={`w-full py-4 px-4 rounded-xl font-bold text-sm shadow-xl transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden group
      ${isGenerating || !config.topic || step === 'results'
        ? 'bg-slate-100 border-2 border-slate-200 cursor-not-allowed text-slate-400 shadow-none' // FIXED: Added border and clearer background for disabled state
        : 'text-white shimmer-btn hover:scale-[1.02] hover:shadow-teal-500/25 active:scale-[0.98]' // FIXED: Moved text-white here
      }`}
