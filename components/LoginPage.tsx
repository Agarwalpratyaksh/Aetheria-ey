...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  // Inside src/components/LoginPage.tsx
const handleLoginClick = () => {
   // validation logic...
   onLogin(selectedRole); // <--- This triggers the router.push in the parent
};
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-50 relative overflow-hidden items-center justify-center p-8 border-r border-slate-200">
        ...
        <div className="absolute bottom-8 left-8 z-10">
          <h2 className="text-2xl font-bold text-slate-800 mb-2">AETHERIA AI</h2>
